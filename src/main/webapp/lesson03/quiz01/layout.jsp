...
%>
	...
	<div id="wrap" class="bg-dark">
		...
		<nav class="menu bg-danger">
            <ul class="nav nav-fill text-white align-items-center"> <!-- nav nav-fill 세트. 메뉴를 nav에 가득 채운다. -->
		...
		<footer class="bg-right text-center">Copyright 2023. marondal All Rights Reserved</footer>
	</div>
</body>
</html>